...
'  if (k.includes("buy") || k.includes("price") || k.includes("pricing") || k.includes("order"))',
'    return { intent: "Transactional", color: "text-emerald-500" };',
'  if (k.includes("best") || k.includes("top") || k.includes("review") || k.includes("vs"))',
...
'    "Analyze the top 10 results and identify content gaps you can fill.",',
'    "Build quality backlinks to improve your ranking potential.",',
'  ];',
'  const radarData = [',
...
'                <div className="flex justify-between p-3 rounded-lg bg-muted/20 border"><span className="text-muted-foreground">Competition</span><span className="font-bold">{result.competitionLevel}/100</span></div>',
